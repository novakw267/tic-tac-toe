...
/***/ function(module, exports, __webpack_require__) {
	...
	var onChangePassword = function onChangePassword(event) {
	  ...
	  api.changePassword(data).then(ui.changePwSuccess).catch(ui.failure);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var spotTaken = function spotTaken(element) {
	  return element !== '';
	};
	...
	var threeInARow = function threeInARow(currentPlayer, cellOne, cellTwo, cellThree) {
	...
	var winRows = function winRows(currentPlayer) {
	  if (threeInARow(currentPlayer, board[0], board[1], board[2]) || threeInARow(currentPlayer, board[3], board[4], board[5]) || threeInARow(currentPlayer, board[6], board[7], board[8])) {
	...
	var winColumn = function winColumn(currentPlayer) {
	  if (threeInARow(currentPlayer, board[0], board[3], board[6]) || threeInARow(currentPlayer, board[1], board[4], board[7]) || threeInARow(currentPlayer, board[2], board[5], board[8])) {
	    return $('#winMessage').text(currentPlayer + ' you won! Feel free to start over, by hitting Play Again.');
	  }
	};
	...
	var winDiag = function winDiag(currentPlayer) {
	  if (threeInARow(currentPlayer, board[0], board[4], board[8]) || threeInARow(currentPlayer, board[2], board[4], board[6])) {
	    return $('#winMessage').text(currentPlayer + ' you won! Feel free to start over, by hitting Play Again.');
	  }
	};
	...
	var winnerIs = function winnerIs(currentPlayer) {
	...
	var yourMove = function yourMove(move) {
	...
	var patch = function patch() {
	  ...
	  .then(ui.onPatchSuccess).catch(ui.onError);
	...
	var handler = function handler(data) {
	  $('.box').on('click', game);
	  $('#games-played').on('click', function () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onIndexSuccess = function onIndexSuccess() {};
